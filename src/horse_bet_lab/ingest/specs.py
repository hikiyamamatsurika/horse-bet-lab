...
SUPPORTED_FILE_SPECS: tuple[FileSpec, ...] = (
    FileSpec(
        ...
        columns=(
            ColumnSpec(
                ...
                True,
                (
                    "Race-level key. The first two characters are treated downstream as the "
                    "upstream venue_code; any broader domain/grouping is project-derived."
                ),
            ),
            ColumnSpec(
                "race_date",
    ...
    FileSpec(
        ...
        columns=(
            ColumnSpec(
                ...
                True,
                (
                    "Race-level key shared with race tables. Downstream venue_code comes from "
                    "race_key[:2]; broader grouping remains project-derived."
                ),
            ),
            ColumnSpec(
                "horse_number",
    ...
    FileSpec(
        file_kind="KYI",
        table_name="jrdb_kyi_staging",
        record_bytes=1022,
        grain="one pre-race card row per race_key and horse_number",
        primary_key_candidates=("race_key", "horse_number"),
        columns=(
            ColumnSpec(
                "race_key",
                ...
                CONFIRMED,
                True,
                "Race-level key shared with other card-oriented JRDB files.",
            ),
            ColumnSpec(
                "horse_number",
                "INTEGER",
                ...
                CONFIRMED,
                True,
                "Horse number within the race card.",
            ),
            ColumnSpec(
                "registration_id",
                "VARCHAR",
                ...
                CONFIRMED,
                False,
                "Pre-race bloodline registration number from official KYI bytes 11-18.",
            ),
            ColumnSpec(
                "horse_name",
                "VARCHAR",
                ...
                CONFIRMED,
                False,
                "Pre-race horse name from official KYI bytes 19-54.",
            ),
            ColumnSpec(
                "jockey_name",
                "VARCHAR",
                ...
                PROVISIONAL,
                True,
                "Jockey name from the KYI card row.",
            ),
            ColumnSpec(
                "carried_weight_kg",
                "DOUBLE",
                ...
                PROVISIONAL,
                True,
                "Leading three digits of the compact KYI weight block in tenths of kilograms.",
            ),
            ColumnSpec(
                "trainer_name",
                "VARCHAR",
                ...
                PROVISIONAL,
                True,
                "Trainer name from the KYI card row.",
            ),
            ColumnSpec(
                "trainer_region",
                "VARCHAR",
                ...
                PROVISIONAL,
                True,
                "Trainer region label from the KYI card row.",
            ),
            ColumnSpec(
                "frame_number",
                "INTEGER",
                ...
                PROVISIONAL,
                True,
                "Frame number from official KYI byte 324.",
            ),
            ColumnSpec(
                "jockey_code",
                "VARCHAR",
                ...
                PROVISIONAL,
                True,
                "Jockey code from official KYI bytes 336-340.",
            ),
            ColumnSpec(
                "trainer_code",
                "VARCHAR",
                ...
                PROVISIONAL,
                True,
                "Trainer code from official KYI bytes 341-345.",
            ),
            ColumnSpec(
                "sex_code",
                "INTEGER",
                ...
                PROVISIONAL,
                True,
                "Sex code from official KYI byte 404.",
            ),
        ),
    ),
    FileSpec(
